...
## Report and pull-request notes

Include these sections in the audit report, fix summary, or authorized pull-request body:
...
Follow [the skill contract](../SKILL.md#contract) for the mode boundary. In audit mode, replace "Docs changed" with "Drift findings."
