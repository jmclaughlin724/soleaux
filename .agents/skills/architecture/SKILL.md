---
name: architecture
description: Design and review contracts, canonical ownership, dependency direction, and placement boundaries across code, configuration, documentation, policies, skills, and agent workflows. Use when deciding where behavior or durable guidance belongs, consolidating duplicate owners, designing modules, or refactoring architecture.
---
...
- [`references/evaluation-dimensions.md`](references/evaluation-dimensions.md) — dimensions to measure when evaluating whether a component, agent workflow, or task outcome meets its contract.
- [`references/agent-anti-patterns.md`](references/agent-anti-patterns.md) — agent-surface configuration anti-patterns and their replacements: prompts, briefs, tool exposure, model routing, and orchestration.
