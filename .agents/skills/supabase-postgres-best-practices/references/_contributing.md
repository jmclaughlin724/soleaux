...
**Good:** "10x faster in the measured workload", "50% smaller in the benchmark", "Eliminates N+1" **Bad:** "Faster", "Better", "More efficient"

Quantify only when a linked source or reproducible benchmark supports the number. Otherwise state the mechanism and require measurement on the target workload.
...
- [ ] The repository's owning validation commands pass
