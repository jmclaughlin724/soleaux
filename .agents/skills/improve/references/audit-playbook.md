...
- Missing or stale repository/owner instructions for a boundary where agents routinely work. Recommend the host's canonical instruction surface only when the absence has a demonstrated execution cost.
