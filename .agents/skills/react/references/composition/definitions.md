...
Blocks are usually consumed as app-owned composition rather than imported as a generic primitive. Registry discovery and application belong to the [shadcn playbook](../../../shadcn/references/skill-playbook.md#discover-and-preview).
...
Many inputs should support both. Learn more about [controlled and uncontrolled state](state.md).
