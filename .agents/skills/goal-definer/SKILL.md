...
1. Confirm that goal definition is actually needed.
   - Use this skill when the user asks for `$goal-definer`, asks to create or set a goal, asks for the goal tool, or wants help turning an intention into a clear objective.
