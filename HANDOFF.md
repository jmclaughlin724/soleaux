...
1. **P5-V1** — the admission receipt verifier at the adapter-wave head once P5-007 lands; P5-W1 crate wiring is closed (evidence: [`P5-W1-CLOSURE-RECEIPT.json`](P5-W1-CLOSURE-RECEIPT.json)). Waves and lanes: [`docs/plans/PHASE5-IMPLEMENTATION-PLAN.md`](docs/plans/PHASE5-IMPLEMENTATION-PLAN.md).
...
Use the stop format in `AGENTS.md` only when a hard contract or evidence condition is actually violated. P5-001 through P5-006 and P5-W1 are closed and must not be reimplemented. Continue with P5-007, following the implementation plan's waves and declared parallel lanes.
